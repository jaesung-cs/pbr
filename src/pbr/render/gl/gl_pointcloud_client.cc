#include "pbr/render/gl/gl_pointcloud_client.h"
...
void PointcloudClient::Generate()
{
  if (generated_)
    Clear();
...
void PointcloudClient::UpdatePointcloud(const pbr::Pointcloud& pointcloud)
{
  if (!generated_)
    Generate();
