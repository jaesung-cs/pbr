#ifndef PBR_ROBOT_ROBOT_MODEL_H_
#define PBR_ROBOT_ROBOT_MODEL_H_

#include <vector>
#include <unordered_map>

#include "pbr/robot/robot_link.h"
#include "pbr/robot/robot_joint.h"
...
#endif // PBR_ROBOT_ROBOT_MODEL_H_
